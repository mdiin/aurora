...
To provide a Hyprland-based Aurora-like experience tailored to my preferences, i.e.:

- No vscode
- No homebrew
- No docker

The rest is awesome though, which is why I fork it instead of duplicating all the other effort.
